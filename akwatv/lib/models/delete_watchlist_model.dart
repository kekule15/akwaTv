...
//
//     final deleteWatchListModel = deleteWatchListModelFromJson(jsonString);

import 'dart:convert';

DeleteWatchListModel deleteWatchListModelFromJson(String str) => DeleteWatchListModel.fromJson(json.decode(str));

String deleteWatchListModelToJson(DeleteWatchListModel data) => json.encode(data.toJson());
...
class DeleteWatchListModel {
    ...
    factory DeleteWatchListModel.fromJson(Map<String, dynamic> json) => DeleteWatchListModel(
