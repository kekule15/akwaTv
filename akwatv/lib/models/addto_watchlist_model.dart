...
AddToWatchListModel addToWatchListModelFromJson(String str) =>
    AddToWatchListModel.fromJson(json.decode(str));

String addToWatchListModelToJson(AddToWatchListModel data) =>
...
class AddToWatchListModel {
  ...
  factory AddToWatchListModel.fromJson(Map<String, dynamic> json) =>
      AddToWatchListModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        subscriptionIsActive: json["subscriptionIsActive"] == null
            ? null
            : json["subscriptionIsActive"],
        watchList: json["watchList"] == null
            ? null
            : List<String>.from(json["watchList"].map((x) => x)),
        ratedList: json["ratedList"] == null
            ? null
            : List<dynamic>.from(json["ratedList"].map((x) => x)),
        ...
        cloudinaryId:
            json["cloudinary_id"] == null ? null : json["cloudinary_id"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "subscriptionIsActive":
            subscriptionIsActive == null ? null : subscriptionIsActive,
        "watchList": watchList == null
            ? null
            : List<dynamic>.from(watchList!.map((x) => x)),
        "ratedList": ratedList == null
            ? null
            : List<dynamic>.from(ratedList!.map((x) => x)),
